...
export const landingText: Record<Language, {
    ...
    en: {
        ...
        agentsSubtitle: 'Three specialized agents work in sequence to turn a resume into a hiring decision.',
        agents: [
            { step: '01', title: 'Parser Agent', description: 'Reads the resume file and extracts skills, experience, and education into structured data.' },
            { step: '02', title: 'Analyst Agent', description: 'Compares the candidate profile against the job description to identify strengths and gaps.' },
            { step: '03', title: 'Reasoning Agent', description: 'Synthesizes a final score and a human-readable recommendation with clear justification.' },
        ],
    ...
    he: {
        ...
        agentsSubtitle: 'שלושה סוכנים מתמחים פועלים ברצף כדי להפוך קורות חיים להחלטת גיוס.',
        agents: [
            { step: '01', title: 'סוכן המפענח', description: 'קורא את קובץ קורות החיים ומחלץ כישורים, ניסיון והשכלה לנתונים מובנים.' },
            { step: '02', title: 'סוכן המנתח', description: 'משווה את פרופיל המועמד לדרישות התפקיד כדי לזהות חוזקות ופערים.' },
            { step: '03', title: 'סוכן ההיסק', description: 'מגבש ציון סופי והמלצה קריאה לבני אדם עם נימוק ברור.' },
        ],
